...
public class MotorPlugin
{
    ...
    [SKName("TURNLEFT")]
    [SKFunction, Description("The car turns anti-clockwise 45 degrees. A complete turn using this commands is 360 degrees.")]
    ...
    [SKName("TURNRIGHT")]
    [SKFunction, Description("The car turns clockwise 45 degrees. A complete turn using this commands is 360 degrees.")]
    [SKParameter("input", "Car movement status")]
